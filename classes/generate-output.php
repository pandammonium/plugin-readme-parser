...
if ( !class_exists( 'Generate_Output' ) ) {
  ...
  class Generate_Output {
     ...
     * `$this->include`.
     *
     * If the head is not explicitly excluded from display, but the metadata is explicitly included, then `$this->show_head` is set to `true` because the summary, which is the part of the head that doesn't have a label such as tags, contributors, version, cannot be displayed without the metadata in the current implementation.
     *
    ...
    /**
     * @var bool Indicates whether the last line read was blank (`true`) or
     * not (`false`): a newline is added to `$this->file_combined` if true.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
     ...
     * being read should be added to the output for display or not. Default = `true`.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
     ...
     * file_combined rather than `$this->standardised_markdown`.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
     ...
     * plugin to display the information for.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
