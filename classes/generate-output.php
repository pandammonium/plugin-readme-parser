...
if ( !class_exists( 'Generate_Output' ) ) {
  ...
  class Generate_Output {
    ...
    /**
     * @var string[] Stores each line of the readme file in its members. Its
     * contents come from `$this->file_data`.
     * * Default: `array()`.
     * @access private
     *
     * @author pandammonium
     ...
     * contents are split into `$this->file_array`. It is also used to store
     * the split HTML generated by the third-party markdown-to-HTML converter.
     * * Default: `array()`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string Stores the value of the `exclude` parameter of the
     * `[readme]` shortcode, which indicates which readme sections should be
     * excluded from display. May not co-occur with `$this->include`; an error
     * will be displayed in this case. If this parameter is used, only those
     * sections not listed will be displayed.
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string Stores the value of the `include` parameter of the
     * `[readme]` shortcode, which indicates which readme sections should be
     * included in the display. May not co-occur with `$this->exclude`; an
     * error will be displayed in this case. If this parameter is used, only
     * those sections listed will be displayed.
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string Stores the value of the `hide` parameter of the
     * `[readme]` shortcode, which indicates which readme sections should be
     * hidden in the display; these sections appear when clicked.
     * * Default: `''`.
     *
     * NB Only functional when the Simple Content Reveal Plugin is installed
     * and activated.
     * @access private
     *
     ...
     * since 23 January 2018, therefore support for this plugin will be
     * removed in a future version. Expect unexpected behaviour when using
     * this parameter.
     */
    private string $hide;
    /**
     * @var string Stores the value of the `links` parameter of the `[readme]`
     * shortcode, which indicates where the links section should be placed. By
     * default, the links are placed at the very end of the readme; setting
     * the `links` to any section title will cause the links to be displayed
    ...
    /**
     * @var string[]|string Stores the value of the `ignore` parameter of the
     * `[readme]` shortcode, which indicates which specific lines should not
     * be displayed.
     * * Default: `''`.
     * @access private
     *
    ...
    /**
     * @var string[]|string Stores the value of the `mirror` parameter of the
     * `[readme]` shortcode, which gives the locations of locations, other
     * than the WordPress plugin directory, where the plugin may be downloaded
     * from.
     * * Default: `''`.
     * @access private
     *
    ...
    /**
     * @var string If the `nofollow` parameter of the `[readme]` and  `[readme_info]` shortcodes is given in the shortcode, this stores the
     * HTML nofollow attribute. If that parameter is not given, this will be
     * an empty string.
     * * Default: `''`.
     * @access private
     *
    ...
    /**
     * @var string Stores the value of the `version` parameter of the
     * `[readme]` shortcode, which, when present, indicates a specific version
     * of the readme to display.
     * * Default: `''`.
     *
    ...
    /**
     * @var string Stores the value of the `target` parameter of the
     * `[readme]` shortcode, which indicates the value that should be used as
     * the value of the target attribute in the HTML tag `<a>`.
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string Stores the value of the `download` value of the data
     * parameter used with the `[readme_info]` shortcode. If set, the link to
     * the download ZIP file on WordPress will be displayed using
     * `$this->content` as the link text.
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string[]|string Stores data used by
     * `$this->add_head_meta_data_to_output`.
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
     * @deprecated 2.0.0 This is used merely to pass data to
     * `$this->add_head_meta_data_to_output` – useful when the functions were
     * a collection of functions, but unnecessary now that they've been
     * converted to a class: that function can access the private data
     * directly, rendering this variable obsolete.
     */
    private array|string $metadata;

    /**
     * @var bool A flag indicating whether the links should be shown or not.
     * Its value is determined using the values of `$this->exclude` and
     * `$this->include`.
     * * Default: `false`.
     * @access private
     *
    ...
    /**
     * @var bool A flag indicating whether the head should be shown or not.
     * Its value is determined using the values of `$this->exclude` and
     * `$this->include`.
     * * Default: `false`.
     *
     * If the head is not explicitly excluded from display, but the metadata
     * is explicitly included, then `$this->show_head` is set to `true`
     * because the summary, which is the part of the head that doesn't have a
     * label such as tags, contributors, version, cannot be displayed without
     * the metadata in the current implementation.
     *
     * NB This is a change from previous behaviour, whereby the entire head
     * would be hidden in these circumstances.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
    ...
    /**
     * @var bool  A flag indicating whether the metadata from the head should
     * be shown or not. Its value is determined using the values of
     * `$this->exclude` and `$this->include`.
     * * Default: `false`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var bool Indicates whether the head is explicitly excluded from
     * display or not.
     * * Default: `false`.
     * @access private
     *
    ...
    /**
     * @var bool Indicates whether the head is explicitly included in the
     * display or not.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var bool Indicates whether the metadata is explicitly excluded from
     * display or not.
     * * Default: `false`.
     * @access private
     *
    ...
    /**
     * @var bool Indicates whether the metadata is explicitly included in the
     * display or not.
     * * Default: `false`.
     * @access private
     *
    ...
    /**
     * @var bool $add_to_output Used to indicate whether the current line
     * being read should be added to the output for display or not.
     * * Default: `true`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string Stores the title of the current section.
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string Stores the title of the previous section. Used for keeping
     * track of which section is currently being read.
     * * Default: `'';''`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var bool
     * * `true`: the last line read was blank
     * * `false`: the last line read was not blank
     * * Default: `true`.
     *
     * A newline is added to `$this->file_combined` if true.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
    ...
    /**
     * @var bool Used to indicate whether there's an open `<div>` tag that
     * needs a matching close `</div>` tag.
     * * Default: `false`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string $file_combined The markdown used in WordPress readme files
     * is a modified form of standard markdown. The third-party markdown
     * converter converts standard markdown text to HTML. The WordPress
     * markdown therefore needs to be standardised before being passed to the
     * markdown converter. The result is stored in `$this->file_combined`,
     * which also contain HTML tags. I assume that's why it's called
     * `$this->file_combined` rather than `$this->standardised_markdown`.
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
    ...
    /**
     * @var string[] Stores each line of the HTML code so it can be processed
     * line by line. Its contents come from splitting `$this->my_html`.
     * * Default: `array()`.
     * @access private
     *
     * @author pandammonium
     * @since 2.0.0
     */
    private array $html_array;
    /**
     * @var string Stores the HTML code to be written out to be displayed on
     * the web page.
     * * Default: `''`.
     * @access private
     *
    ...
    /**
     * @var string Stores the value of the `name` parameter in the
     * `[readme_info]` shortcode, which provides the name of the WordPress
     * plugin to display the information for. It can take the form of the
     * plugin's title (e.g. Plugin-Readme Parser) or its slug (e.g.
    ...
    private string $name;
    /**
     * @var string Stores the value of the `data` parameter in the
     * `[readme_info]` shortcode, which indicates the information requested about the plugin given by `$this->name`. Valid values are:
     * * `version`: gets the latest version of the plugin
     * * `download`: gets the link to where the latest version can be
     * downloaded from as a ZIP file
     * * `forum`: gets the link to the support forum
     * * `wordpress`: gets the link to the offical WordPress plugin page
     * * Default: `''`.
     * @access private
     *
     * @author pandammonium
        ...
        try {
          ...
          if ( false === $result ) {
            ...
            if ( false === $this->file_data ) {
              $this->process_invalid_readme_file();
            } else {
              $this->process_valid_readme_file();
            }
     ...
     * @return void
     */
    private function standardise_wordpress_markdown(): void {
    ...
    private function write_html(): void {
      ...
      for ( $i = 0; $i < $count; $i++ ) {
        ...
        if ( '' !== $this->html_array[ $i ] ) {
          $this->my_html .= $this->html_array[ $i ] . self::LINE_END;
        }
      }
    ...
    private function normalise_html_code_tags( int $i ): void {
      ...
      // If first line of code is multi-line, replace CODE with PRE tag

      if ( ( strpos( $this->html_array[ $i ], '<code>', 0 ) ) && ( !strpos( $this->html_array[ $i ], '</code>', 0 ) ) ) {
        $this->html_array[ $i ] = str_replace( '<code>', '<pre>', $this->html_array[ $i ] );
      }
      ...
      if ( ( strpos( $this->html_array[ $i ], '<code>', 0 ) ) && ( strpos( $this->html_array[ $i ], '</code>', 0 ) ) ) {
        if ( '' === ltrim( strip_tags( substr( $this->html_array[ $i ], 0, strpos( $this->html_array[ $i ], '<code>', 0 ) ) ) ) ) {
          $this->html_array[ $i ] = str_replace( 'code>', 'pre>', $this->html_array[ $i ] );
        }
      }
    }
    ...
    private function process_valid_readme_file(): void {
    ...
    /**
     * Determine which parts of the head metadata, if any, should
     * be added to the output.
     *
     * The head comprises the plugin title/name, the metadata and
     * a summary/description of the plugin. There may be one or
     * more blank lines. This function deals with the metadata
     * only.
     *
     * The metadata is the labelled data, such as tags, licence
    ...
    function add_head_meta_data_to_output( $i ): bool {
      ...
      if ( $this->show_head || $this->show_meta ) {
        ...
        if ( $this->line_is_head_meta_data( $i ) ) {
          ...
          // prp_log( __( 'line is not metadata but is in head; add to output', plugin_readme_parser_domain ), ( $add_to_output ? 'true' : 'false' ) );
      ...
      // prp_log( __( 'add head metadata to output', plugin_readme_parser_domain ), ( $add_to_output ? 'true' : 'false' ) );
    ...
    /**
     * Checks that the the readme file line is head metadata.
     *
     * Tests to see whether the current line in the readme file is a line in
     * the head metadata (e.g. tags, licence, contributors) or not.
     *
     * @author pandammonium
  ...
  if ( !function_exists( 'readme_parser' )) {
     ...
     * @example https://pandammonium.org/wordpress/wordpress-dev/blipper-widget/blipper-widget-readme/ The readme for the Blipper Widget plugin is shown in full. It is generated by the shortcode `[readme nofollow=”yes”]Blipper Widget[/readme]`.
     */
